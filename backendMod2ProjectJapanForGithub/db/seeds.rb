...
tempura_ginya =Place.create(name: "tempura_ginya", description: "Tokyo is known for the best tempura in the world, and this is one of the best in Tokyo.", category: "restaurant", price: 3, location: "Tokyo")
ginza_kyubey =Place.create(name: "ginza_kyubey", description: "One of the top sushi restaurants in the world, and not entirely impossible to get into. The experience is really fun.", category: "restaurant", price: 3, location: "Tokyo")
...
Place.create(name: "Dotonbori", description: "Street food capital of Japan. Iconic street lights and shops.", category: "attraction", price: 1, location: "Osaka")
